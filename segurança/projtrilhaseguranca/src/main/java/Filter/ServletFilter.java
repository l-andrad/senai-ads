...
public class ServletFilter implements Filter{
    ...
    /*
     * O método abstrato init() é exigido por esta
     * classe neste caso este método indicará que o
     * Filtro deverá executar algo quando o Filtro
     * for carregado pelo Container(Servlet).
     */
     ...
     * Filtro, este por sua vez, recebe 3 parâmetros (ServletRequest,
     * ServletResponse e FilterChain). Perceba a semelhança deste método com o
     * método Service da classe Servlet.
     */
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
         ...
         * variável contexto e esclareça sua dúvida ok?
         */
